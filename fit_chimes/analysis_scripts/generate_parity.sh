...
paste validation_data/b-labeled_DFT.txt validation_data/b-labeled_DFTB.txt > compare_all_DFTvsDFTB.txt
...
paste validation_data/b-labeled_DFT.txt validation_data/b-labeled_DFTB.txt force.txt | awk '{print($1, $2, $4+$5)}' > compare_all_DFTvsDFTB+ChIMES.txt
